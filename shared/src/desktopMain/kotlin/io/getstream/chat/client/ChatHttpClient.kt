...
/**
 * Desktop (JVM) implementation of [ChatHttpClient] using Ktor's CIO engine.
 *
 * @property config The HTTP client configuration
 * @property isDebug Whether the app is running in debug mode
 * @property trustStore Optional custom trust store for SSL/TLS
 */
    ...
    private val client: HttpClient by lazy {
        val engine = CIOEngine {
            ...
            endpoint {
                ...
                pipelineMaxSize = 20
                keepAliveTime = 5000
                connectTimeout = config.timeout.connect.inWholeMilliseconds
                connectAttempts = 5
            }
        }
